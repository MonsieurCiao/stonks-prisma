...
export default async function Navbar() {
  ...
  return (
    <nav className="fixed bottom-4 md:bottom-auto md:top-4 left-4 right-4 rounded-lg border-2 border-border px-8 flex justify-center items-center bg-background z-1">
      <div className="flex justify-between items-center w-full md:w-auto md:gap-10">
        ...
        >
          <div className="flex gap-1 md:gap-2 flex-col items-center md:flex-row">
            <Image src={"/Target.svg"} alt="Home" width={18} height={18} />
